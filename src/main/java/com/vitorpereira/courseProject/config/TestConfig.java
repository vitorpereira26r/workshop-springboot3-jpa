...
import com.vitorpereira.courseProject.entities.*;
import com.vitorpereira.courseProject.entities.enums.OrderStatus;
import com.vitorpereira.courseProject.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        OrderItem oi2 = new OrderItem(o1, p3, 1, p3.getPrice()*1);
        OrderItem oi3 = new OrderItem(o2, p3, 2, p3.getPrice()*2);
        OrderItem oi4 = new OrderItem(o3, p5, 2, p5.getPrice()*2);
